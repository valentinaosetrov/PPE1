...
mot="[Šš]treber(i|a|u|ima|e|ka|ki|ku|kama|ke)?" # différentes formes du mot (genre/nombre/les cas + écriture emprunté )
...
bash ./concordance2.sh ././dumps-text/$basename-$lineno.txt "$mot" > ./concordances/$basename-$lineno.html
